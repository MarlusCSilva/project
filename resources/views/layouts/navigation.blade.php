<nav x-data="{ open: false }" class="bg-black dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed-topgit">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('myeventos')" :active="request()->routeIs('myeventos')">
                        {{ __('Meus Eventos') }}
                    </x-nav-link>
                </div>
            </div>
